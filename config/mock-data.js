...
const MOCK_DATA = {
    ...
    chat: {
        ...
        messages: [
            {
                role: 'assistant',
                content: '你好！我是ThinkCraft AI思维助手 🤖\n\n我可以帮你进行创意的深度分析和验证。我们将通过6个关键问题，运用五看三定、SWOT等专业方法论，一起打磨你的想法。\n\n准备好了吗？让我们开始吧！\n\n**请描述一下你的创意想法：**'
            },
            {
                role: 'user',
            ...
            {
                role: 'assistant',
                content: '很棒的方向！健身市场确实有巨大潜力。让我帮你深入分析一下。\n\n💡 **初步想法**：AI健身教练APP\n\n接下来，让我们明确一下核心要素：\n\n**这个APP主要解决什么人的什么问题？请描述你的目标用户：**\n\n💭 *提示：可以从年龄、职业、痛点等维度思考*'
            },
            {
                role: 'user',
            ...
            {
                role: 'assistant',
                content: '非常精准的用户画像！你抓住了一个真实的市场痛点。\n\n👥 **目标用户**：25-40岁职场人士\n🎯 **核心痛点**：\n- 时间有限，工作繁忙\n- 缺乏专业指导\n- 私教费用过高\n\n现在让我们聚焦解决方案：\n\n**你打算如何解决这个问题？具体的产品/服务方案是什么？**'
            },
            {
                role: 'user',
            ...
            {
                role: 'assistant',
                content: '优秀！技术路线很清晰，而且抓住了"实时反馈"这个关键点。\n\n🔧 **核心方案**：\n- ✅ 计算机视觉：实时动作识别\n- ✅ AI算法：个性化训练计划\n- ✅ 1对1指导：模拟私教体验\n\n这个方案的技术实现是可行的。接下来我们需要明确差异化：\n\n**相比市面上的Keep、每日瑜伽等APP，你的独特价值是什么？为什么用户要选择你？**'
            },
            {
                role: 'user',
            ...
            {
                role: 'assistant',
                content: '太棒了！你找到了一个强有力的差异化点。\n\n🌟 **核心竞争优势**：\n1. **技术壁垒**：实时动作识别 vs 传统视频教学\n2. **用户体验**：即时反馈 vs 自我判断\n3. **价格优势**：私教成本的1/10\n\n这个差异化很有说服力。现在我们来思考商业模式：\n\n**你打算如何赚钱？预计的收费模式和价格区间是怎样的？**'
            },
            {
                role: 'user',
            ...
            {
                role: 'assistant',
                content: '完整的商业闭环！你的变现路径很清晰。\n\n💰 **商业模式**：\n- **订阅制**：99元/月 或 699元/年（约58元/月）\n- **课程包**：增肌、减脂等专项课程\n- **电商分成**：健身器材推荐\n\n📊 **收入预测**（假设）：\n- 1万付费用户 × 58元/月 = 58万/月\n- 课程包转化率10% × 200元 = 20万/月\n- 总计：约80万/月稳定收入\n\n最后一个关键问题，关于启动成本：\n\n**初期需要投入多少资金？主要花在哪些方面？**'
            },
            {
                role: 'user',
            ...
            {
                role: 'assistant',
                content: '非常详细的成本规划！让我帮你整理一下：\n\n💵 **启动资金：300万**\n- 技术研发：150万（AI模型 + App开发）\n- 市场推广：100万\n- 运营成本：50万/年\n\n📈 **投资回报分析**：\n- 假设6个月内获取1万付费用户\n- 月收入80万 × 12个月 = 960万/年\n- 扣除运营成本，净利润约800万\n- **回本周期：约4-5个月**\n\n🎉 **恭喜！我们已经完成了深入的探讨。**\n\n通过这6个核心问题，我们明确了：\n✅ 目标用户和核心痛点\n✅ 差异化的解决方案\n✅ 清晰的商业模式\n✅ 完整的成本规划\n\n现在可以点击下方的 **"📊 查看完整报告"** 按钮，生成结构化分析报告，包括：\n- 📊 五看三定分析\n- 💼 市场机会评估\n- ⚡ SWOT分析\n- 🎯 关键假设验证\n- ⚠️ 风险与应对策略\n\n[ANALYSIS_COMPLETE]'
            }
        ]
    },
